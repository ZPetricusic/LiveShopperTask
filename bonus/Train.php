...
class Train{
    ...
    public function addTrainCar(TrainCar $t, $placementSide){
        ...
        if($this->isEngineConnected && ($t instanceof EngineCar))
        ...
        if( ($t instanceof EngineCar) && (count($this->carChain) > 0) ){
    ...
    public function removeTrainCar($placementSide){
            ...
            if(($removedCart instanceof EngineCar)){
